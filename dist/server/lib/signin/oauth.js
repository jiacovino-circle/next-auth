...
function _getAuthorizationUrl() {
  _getAuthorizationUrl = _asyncToGenerator(function* (req) {
    ...
    var params = _objectSpread(_objectSpread({}, provider.authorizationParams), req.query);
    ...
    if ((_provider$version = provider.version) !== null && _provider$version !== void 0 && _provider$version.startsWith('2.')) {
      var url = client.getAuthorizeUrl(_objectSpread(_objectSpread({}, params), {}, {
    ...
    try {
      var tokens = yield client.getOAuthRequestToken(params);

      var _url = "".concat(provider.authorizationUrl, "?").concat(new URLSearchParams(_objectSpread({
